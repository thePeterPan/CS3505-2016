...
//    int *test_array[5] = {};
//    bool test = test_array[4] == nullptr;
//    test_array[3] = new int(4);
//    bool test2 = test_array[3] == nullptr;
//    cout << test << endl;
//    cout << test2 << endl;
...
//        node test('0');
//        test.addChildNode('a');
//        bool asdf = test.childNodeExists('b');
//        
//        node* node_ptr = test.getChildNode('b');
    
//    Trie newTrie;
////    newTrie.addWord("test");
//    newTrie.addWord("tester");
//    newTrie.addWord("testar");
//    cout << newTrie.isWord("test") << endl;
//    cout << newTrie.isWord("tester") << endl;
//    cout << newTrie.isWord("testers") << endl;
//    cout << newTrie.isWord("") << endl;
//    std::vector<std::string> list = newTrie.allWordsWithPrefix("test");
