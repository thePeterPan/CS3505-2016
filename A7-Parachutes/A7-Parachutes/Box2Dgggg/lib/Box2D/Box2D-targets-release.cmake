...
set_target_properties(Box2D_shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libBox2D.so.2.3.2"
  IMPORTED_SONAME_RELEASE "libBox2D.so.2.3.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS Box2D_shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_Box2D_shared "${_IMPORT_PREFIX}/lib/libBox2D.so.2.3.2" )
